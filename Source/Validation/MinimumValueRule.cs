...
namespace Junior.Ddd.Validation
{
	...
	public class MinimumValueRule<TValidationError, TValue> : Rule<TValidationError>
		...
		where TValue : IComparable
	{
		...
		public MinimumValueRule(TValue minimumValue, TValidationError validationError, TValue value, params IRule<TValidationError>[] dependsOn)
		...
		/// <param name="dependsOn">Rules that must pass validation before validating this rule.</param>
		public MinimumValueRule(TValue minimumValue, TValidationError validationError, TValue value, TValidationError stopValidatingOn, params IRule<TValidationError>[] dependsOn)
		...
		public MinimumValueRule(TValue minimumValue, TValidationError validationError, TValue value, IEnumerable<TValidationError> stopValidatingOn, params IRule<TValidationError>[] dependsOn)
		...
		{
			if (Comparer<TValue>.Default.Compare(_value, _minimumValue) < 0)
			{

...
namespace Junior.Ddd.Validation
{
	...
	public class MaximumValueRule<TValidationError, TValue> : Rule<TValidationError>
		...
		where TValue : IComparable
	{
		...
		public MaximumValueRule(TValue maximumValue, TValidationError validationError, TValue value, params IRule<TValidationError>[] dependsOn)
		...
		/// <param name="dependsOn">Rules that must pass validation before validating this rule.</param>
		public MaximumValueRule(TValue maximumValue, TValidationError validationError, TValue value, TValidationError stopValidatingOn, params IRule<TValidationError>[] dependsOn)
		...
		public MaximumValueRule(TValue maximumValue, TValidationError validationError, TValue value, IEnumerable<TValidationError> stopValidatingOn, params IRule<TValidationError>[] dependsOn)
		...
		{
			if (Comparer<TValue>.Default.Compare(_value, _maximumValue) > 0)
			{
